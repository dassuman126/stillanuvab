...
<head>
  ...
  margin-left: 5px;
    ...
    font-weight: 100 !important;
        ...
        .active-nav-link {
            background: #5b6a9e;
    box-shadow: -6px -2px 20px 1px #838383;
        ...
        <nav class="text-white text-base font-semibold">
            ...
            @can('admin-only')
                <a href="{{ route('admin.category.index') }}"
                    class="{{ request()->routeIs('*.category.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100' }} flex items-center text-white py-2 pl-6 nav-item">
            ...
            <a href="{{ route('admin.album.index') }}"
                class="{{ request()->routeIs('*.album.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100' }} flex items-center text-white py-2 pl-6 nav-item">
            ...
            {{-- <a href="{{ route('admin.tag.index') }}"
                class="{{ request()->routeIs('*.tag.*') ? 'active-nav-link' : 'opacity-75 hover:opacity-100' }} flex items-center text-white  py-2 pl-6 nav-item">
...
@if (request()->routeIs('*.album.index') || request()->routeIs('*.category.index'))
<!-- CDN -->
...
@endif
@if (request()->routeIs('*.album.create') || request()->routeIs('*.album.edit'))
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js"
integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ=="
crossorigin="anonymous" referrerpolicy="no-referrer"></script>
