        ...
        <main class="w-full flex-grow p-6">
            ...
            <div class="w-full mt-2">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list mr-3"></i> Edit Album Details
                </p>
                <form method="POST" action="{{ route('admin.album.update', $post->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                ...
                {{--  --}}
                    ...
                    <div class="mb-2">
                        ...
                        <div id="previewContainer">
                            @if($post->image)
                            <img id="previewImage" src="{{ asset("storage/$post->image") }}" alt="Image Preview" style="width:224px;">
                            @else
