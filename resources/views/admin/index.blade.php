    ...
    <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            ...
            <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-6">
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-lg bg-white ">
                    <div class="px-10 py-6">
                        <div class="font-bold text-xl mb-2 text-center">Albums</div>
                        <p class="text-gray-700 text-5xl text-center">
                            {{ $posts }}
                        </p>
                    </div>
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-lg bg-white ">
                    <div class="px-10 py-6">
                        <div class="font-bold text-xl mb-2 text-center">Photos</div>
                        <p class="text-gray-700 text-5xl text-center">
                            {{ $tags }}
                        </p>
                    </div>
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-lg bg-white ">
                    <div class="px-10 py-6">
                        <div class="font-bold text-xl mb-2 text-center">Comments</div>
                        <p class="text-gray-700 text-5xl text-center">
                            {{ $users }}
                        </p>
                    </div>
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-lg bg-white ">
                    <div class="px-10 py-6">
                        <div class="font-bold text-xl mb-2 text-center">User Query</div>
                        <p class="text-gray-700 text-5xl text-center">
                            {{ $news_letter_users }}
                        </p>
                    </div>
